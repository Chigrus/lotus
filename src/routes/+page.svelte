				...
				<div class="content_about">
					...
					<div class="about_info">
						...
						<div class="about_line">
							...
							<div class="about_line_text">Так хочется поговорить о том, какие ощущения вызывает в тебе жизнь, об интересных задумках, которые планируешь 
								реализовать. Но все вокруг обсуждают только новости из телека или “что сегодня на обед”. Поэтому я решила создать свой мир, где 
								общаются на действительно глубокие темы.</div>
